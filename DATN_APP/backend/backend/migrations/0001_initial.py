# Generated by Django 3.2.25 on 2024-05-31 15:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Factlichsugia',
            fields=[
                ('MaLichSuGia', models.AutoField(primary_key=True, serialize=False)),
                ('MaChungKhoan', models.CharField(max_length=255)),
                ('NgayGiaoDich', models.DateTimeField()),
        ...
        migrations.CreateModel(
            name='Nguongcanhbao',
            fields=[
                ('MaCanhBao', models.AutoField(primary_key=True, serialize=False)),
